...
ExpectedOutputs = int32([16777216,674,0;
          16777216,674,0;
          16777216,-2147483647,0;
          16777216,2147483647,0;
          142606337,2147483647,0;
          142606337,-2147483647,0;
          142606337,-2147483647,0;
          134217728,7000,0;
         142606337,0,0;
         ...
         67108864,-2147483647,256;
         142606337,-2147483647,256;
        268435456,-2147483647,256;
         16777216,-2147483647,256;
         67108864,-2147483647,256;
          ])
            
tf = sltest.testmanager.TestFile('MAX'); %name of the mldatx file
ts = getTestSuites(tf);
tc = getTestCases(ts);
results = run(tc(1));
...
for i = 1:TestIters
   TestInps = i;
   sim('FBFunctions_Harness_MAX',10); % 
