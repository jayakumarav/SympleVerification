...
Inputs = int32([67108864,4,67108864,0;% Int and Int
               ...
               67108864, 1,67108864,1; % Int and Int
...
tf = sltest.testmanager.TestFile('BOR'); %name of the mldatx file
ts = getTestSuites(tf);
tc = getTestCases(ts);
results = run(tc(1));
...
for i = 1:TestIters
   TestInps = i;
   sim('FBFunctions_Harness_BOR',10); % 
